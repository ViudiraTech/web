...
import { activateLiquidGlassElement, setLiquidGlassState } from '../glass/liquid-glass.js';
...
function statusBar() {
  return `<div class="ios27-statusbar" data-ios-statusbar>
    ...
    <button class="ios27-dynamic-island liquid-glass" data-ios-island data-glass-preset="ios-island" data-glass-live="true" data-glass-keep-active="true" type="button" aria-label="实时活动"><span class="ios27-island-dot"></span><span class="ios27-island-wave"><i></i><i></i><i></i><i></i></span><span class="ios27-island-copy"><b>夜航星</b><small>Viudira Music</small></span><span class="ios27-island-play">${icon.pause(17)}</span></button>
...
function lockScreen() {
  return `<section class="ios27-lockscreen" data-ios-lockscreen aria-label="iOS 27 锁定屏幕">
    ...
    <div class="ios27-lock-notification liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true"><span>${appGlyph('messages')}</span><div><b>信息</b><small>Liquid Glass 已准备完成</small></div><time>现在</time></div>
...
function homeScreen() {
  ...
  return `<section class="ios27-home" data-ios-home aria-label="iOS 27 主屏幕">
    ...
    <button class="ios27-home-search liquid-glass" data-ios-spotlight-open data-glass-preset="ios-control" data-glass-live="true" data-glass-keep-active="true">${icon.search(16)}<span>搜索</span></button>
    <div class="ios27-page-dots"><i class="is-active"></i><i></i></div>
    <div class="ios27-dock liquid-glass" data-glass-preset="ios-dock" data-glass-live="true" data-glass-keep-active="true">${dock}</div>
  </section>`;
}
...
function safariApp() {
  return `<article class="ios27-app ios27-app--safari" data-ios-app="safari" aria-label="Safari">
    ...
    <form class="ios27-safari-bottom liquid-glass" data-glass-preset="ios-dock" data-glass-live="true" data-glass-keep-active="true" data-ios-safari-form><button type="button">${icon.back(18)}</button><label>${icon.search(16)}<input data-ios-safari-input value="viudiratech.local" aria-label="Safari 地址"/></label><button type="button" data-ios-toast="标签页">▢</button></form>
  </article>`;
}
...
function genericApp(kind, title) {
  const body = kind === 'camera' ? `<div class="ios27-camera-view"><div class="ios27-camera-focus"></div><div class="ios27-camera-controls"><span></span><button data-ios-toast="已拍摄"> </button><span>↻</span></div></div>` : `<div class="ios27-generic-content">${appGlyph(kind)}<h1>${title}</h1><p>这是 iOS 27 模拟器中的 ${title} 演示界面。</p></div>`;
...
function controlCenter() {
  return `<aside class="ios27-overlay ios27-control-center" data-ios-control-center aria-hidden="true">
    ...
    <div class="ios27-cc-grid">
      <section class="ios27-cc-connectivity liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true"><button class="is-active" data-ios-cc-tile="airplane">${icon.airplane()}<span>飞行模式</span></button><button class="is-active" data-ios-cc-tile="wifi">${icon.wifi(20)}<span>Wi‑Fi</span></button><button class="is-active" data-ios-cc-tile="bluetooth">${icon.bluetooth()}<span>蓝牙</span></button><button data-ios-cc-tile="cell">▰<span>蜂窝网络</span></button></section>
      <section class="ios27-cc-nowplaying liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true"><span class="ios27-cc-art">V</span><div><b>夜航星</b><small>Viudira Mix</small></div><button data-ios-music-play>${icon.pause()}</button></section>
      <section class="ios27-cc-slider liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true"><span>${icon.sun()}</span>${liquidSlider({value:72,ariaLabel:'亮度',setting:'iosBrightness'})}</section>
      <section class="ios27-cc-slider liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true"><span>${icon.speaker()}</span>${liquidSlider({value:44,ariaLabel:'音量',setting:'iosVolume'})}</section>
      <button class="ios27-cc-small liquid-glass" data-glass-preset="ios-control" data-glass-live="true" data-glass-keep-active="true" data-ios-cc-tile="focus"><b>◐</b><span>专注模式</span></button>
      <button class="ios27-cc-small liquid-glass" data-glass-preset="ios-control" data-glass-live="true" data-glass-keep-active="true" data-ios-cc-tile="rotation"><b>↻</b><span>方向锁定</span></button>
      <button class="ios27-cc-small liquid-glass" data-glass-preset="ios-control" data-glass-live="true" data-glass-keep-active="true" data-ios-toast="屏幕镜像"><b>▣</b><span>屏幕镜像</span></button>
      <button class="ios27-cc-small liquid-glass" data-glass-preset="ios-control" data-glass-live="true" data-glass-keep-active="true" data-ios-toast="相机"><b>◎</b><span>相机</span></button>
    </div>
  </aside>`;
}

function notificationCenter() {
  return `<aside class="ios27-overlay ios27-notification-center" data-ios-notifications aria-hidden="true"><header><small>8月16日</small><strong>星期日</strong></header><div class="ios27-notification-stack"><article class="liquid-glass" data-glass-preset="ios-popover" data-glass-live="true"><span>${appGlyph('messages')}</span><div><b>信息</b><p>iOS 27 手机端模拟已经启用。</p></div><time>现在</time></article><article class="liquid-glass" data-glass-preset="ios-popover" data-glass-live="true"><span>${appGlyph('calendar')}</span><div><b>日历</b><p>20:00 · ViudiraTech</p></div><time>1小时前</time></article></div></aside>`;
}

function spotlight() {
  return `<aside class="ios27-spotlight" data-ios-spotlight aria-hidden="true"><div class="ios27-spotlight-search liquid-glass" data-glass-preset="ios-popover" data-glass-live="true" data-glass-keep-active="true">${icon.search(20)}<input data-ios-spotlight-input placeholder="搜索 App 和内容"/><button data-ios-spotlight-close>取消</button></div><div class="ios27-spotlight-results" data-ios-spotlight-results></div></aside>`;
}
...
export function ios27Simulator() {
  return `<section class="ios27-sim" data-ios27-sim data-ios-state="locked" aria-label="iOS 27 模拟器">
    ...
    <div class="ios27-toast liquid-glass" data-ios-toast-box data-glass-preset="ios-control" data-glass-live="true" aria-live="polite"></div>
...
function bindDirectGesture(zone, { onStart, onMove, onEnd }) {
  let active = false, id = null, sx=0, sy=0, lx=0, ly=0, lastT=0, velocityY=0, velocityX=0;
  zone.addEventListener('pointerdown', (e) => {
    if (e.pointerType === 'mouse' && e.button !== 0) return;
    active = true; id=e.pointerId; sx=lx=e.clientX; sy=ly=e.clientY; lastT=performance.now(); velocityX=velocityY=0;
    zone.setPointerCapture?.(id); onStart?.(e);
  });
  zone.addEventListener('pointermove', (e) => {
    if (!active || e.pointerId !== id) return;
    const now=performance.now(), dt=Math.max(now-lastT,1); velocityX=(e.clientX-lx)/dt; velocityY=(e.clientY-ly)/dt; lx=e.clientX; ly=e.clientY; lastT=now;
    onMove?.({event:e,dx:e.clientX-sx,dy:e.clientY-sy,velocityX,velocityY});
  });
  const finish = (e,cancel=false) => { if(!active || (e.pointerId!=null && e.pointerId!==id)) return; active=false; onEnd?.({event:e,dx:lx-sx,dy:ly-sy,velocityX,velocityY,cancel}); };
  zone.addEventListener('pointerup', e=>finish(e,false)); zone.addEventListener('pointercancel',e=>finish(e,true));
}
...
export function bindIos27Simulator(root=document.querySelector('[data-ios27-sim]')) {
  ...
  root.querySelectorAll('.liquid-glass[data-glass-preset^="ios-"]').forEach(activateLiquidGlassElement);
  ...
  const renderApp=(p)=>{
    const rect=root.getBoundingClientRect(); const src=sourceRect || {left:rect.width/2-28,top:rect.height-95,width:56,height:56};
    const cx=src.left+src.width/2-rect.left, cy=src.top+src.height/2-rect.top; const dx=cx-rect.width/2, dy=cy-rect.height/2;
    const s0=Math.max(.065,Math.min(src.width/rect.width,src.height/rect.height)*1.15); const scale=mix(s0,1,p);
    stage.style.transform=`translate3d(${(dx*(1-p)).toFixed(2)}px,${(dy*(1-p)).toFixed(2)}px,0) scale(${scale.toFixed(5)})`;
    stage.style.borderRadius=`${mix(26,0,p).toFixed(2)}px`; stage.style.opacity=clamp(p*1.35).toFixed(4);
    stage.style.pointerEvents=p>.97?'auto':'none'; home.style.transform=`scale(${mix(1,.91,p).toFixed(4)})`; home.style.filter=`blur(${mix(0,8,p).toFixed(2)}px)`; home.style.opacity=mix(1,.45,p).toFixed(4);
  ...
  const renderPage=(p)=>{ page=clamp(p); root.querySelector('[data-ios-home-pages]').style.transform=`translate3d(${(-50*page).toFixed(3)}%,0,0)`; root.querySelectorAll('.ios27-page-dots i').forEach((dot,i)=>dot.classList.toggle('is-active',i===Math.round(page))); };
  ...
  const openApp=(kind, trigger)=>{
    ...
    sourceRect=trigger?.getBoundingClientRect?.() || sourceRect; activeApp=kind;
    if(appMotion.value>.12){ appMotion.snap(Math.max(appMotion.value,.96)); appMotion.to(1); } else appMotion.to(1);
  };
  ...
  bindDirectGesture(root.querySelector('[data-ios-home-gesture]'),{
    onStart(){
      if(!unlocked){ homeGestureStart=unlock.value; unlock.snap(homeGestureStart); }
      else if(activeApp){ homeGestureStart=appMotion.value; appMotion.snap(homeGestureStart); }
    },
    onMove({dy}){
      const h=Math.max(root.clientHeight,1);
      if(!unlocked) unlock.snap(clamp(homeGestureStart + (-dy/h)*.92));
      else if(activeApp) appMotion.snap(clamp(homeGestureStart + (dy/h)*1.22));
    },
  ...
  bindDirectGesture(root.querySelector('[data-ios-cc-gesture]'),{
    onStart(){ ccGestureStart=ccMotion.value; ccMotion.snap(ccGestureStart); ncMotion.to(0); spotMotion.to(0); },
    onMove({dy}){ ccMotion.snap(clamp(ccGestureStart + dy/Math.max(root.clientHeight*.55,1))); },
  ...
  bindDirectGesture(root.querySelector('[data-ios-notification-gesture]'),{
    onStart(){ ncGestureStart=ncMotion.value; ncMotion.snap(ncGestureStart); ccMotion.to(0); spotMotion.to(0); },
    onMove({dy}){ ncMotion.snap(clamp(ncGestureStart + dy/Math.max(root.clientHeight*.58,1))); },
  ...
  bindDirectGesture(cc,{onStart(){ccPanelStart=ccMotion.value;ccMotion.snap(ccPanelStart);},onMove({dy}){ccMotion.snap(clamp(ccPanelStart+dy/Math.max(root.clientHeight*.5,1)));},onEnd({dy,velocityY}){ccMotion.to(ccMotion.value>.58 && !(dy<-55||velocityY<-.45)?1:0);}});
  bindDirectGesture(notifications,{onStart(){ncPanelStart=ncMotion.value;ncMotion.snap(ncPanelStart);},onMove({dy}){ncMotion.snap(clamp(ncPanelStart+dy/Math.max(root.clientHeight*.5,1)));},onEnd({dy,velocityY}){ncMotion.to(ncMotion.value>.58 && !(dy<-55||velocityY<-.45)?1:0);}});

  // Horizontal Home/App Library paging: fully interruptible spring + direct drag.
  let pageStart=0;
  bindDirectGesture(home,{
    onStart(e){ if(activeApp || e.target.closest('button,input,[data-liquid-slider]')) return; pageStart=pageMotion.value; pageMotion.snap(pageStart); home.dataset.pageGesture='1'; },
    onMove({dx,dy}){ if(home.dataset.pageGesture!=='1'||Math.abs(dy)>Math.abs(dx)*1.3)return; pageMotion.snap(clamp(pageStart-dx/Math.max(root.clientWidth*.72,1))); },
  ...
  root.querySelector('[data-ios-spotlight-open]')?.addEventListener('click',()=>{closeOverlays();spotMotion.to(1);const input=root.querySelector('[data-ios-spotlight-input]');const results=root.querySelector('[data-ios-spotlight-results]');results.innerHTML=searchResults(root,'');setTimeout(()=>input?.focus(),120);});
  ...
  const renderIsland=(p)=>{ island.style.setProperty('--island-open',p.toFixed(4)); island.classList.toggle('is-expanded',p>.5); setLiquidGlassState(island,{intensity:.82+.18*p,blur:mix(4,8,p),surfaceAlpha:mix(.25,.42,p),highlightAlpha:1}); };
  const islandMotion=makeSpring(0,renderIsland,{dampingRatio:.72,stiffness:390}); island.addEventListener('click',()=>{islandMotion.snap(islandMotion.value);islandMotion.to(islandMotion.value>.45?0:1);});
  ...
  const glassSlider=root.querySelector('[data-setting-slider="iosGlass"]'); glassSlider?.addEventListener('liquidslider:input',(e)=>{
    ...
    root.querySelectorAll('.liquid-glass[data-glass-preset^="ios-"]').forEach(el=>setLiquidGlassState(el,{surfaceAlpha:mix(.12,.52,t),blur:mix(5,18,t),intensity:mix(1.08,.9,t),highlightAlpha:1}));
  });
