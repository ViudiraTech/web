...
export function techMap(repos = []) {
  return `<section class="section section--compact" id="about"><div class="container">
    ...
    <div class="tech-graph reveal">
      ...
      <article class="tech-node"><span class="tech-label">05 / RESEARCH</span><h3>Experimental</h3><p>处于技术探索阶段、用于验证新方向与工程方法的公开仓库。</p><div class="tech-repos">${namesBy(repos,'Experimental')}</div></article>
    </div>
  </div></section>`;
}
